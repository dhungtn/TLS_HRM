...
namespace BUS
{
    public class BUS_Timesheet
    {
        public static List<Timesheet> selectBangcong(int thang, int nam)
        {
            return DAO.DAO_Timesheet.selectBangcong(thang,nam);
        }
        // kiem tra trung ngay cong khi them
        public static bool kiemtra_ngaycong_trung(string manv, DateTime ngaycong)
        {
            return DAO.DAO_Timesheet.kiemtra_ngaycong_trung(manv, ngaycong);
        }
        ...
        {
            return DAO.DAO_Timesheet._xoa(manv, thang, nam);
        }
        #endregion 
        ...
        {
            return DAO.DAO_Timesheet._xoaNgaycong(manv,ngay, thang, nam);
        }
        #endregion 
        ...
        {
            return DAO.DAO_Timesheet.selectBangcong_1NV(manv, thang, nam);
        }
        #endregion
        ...
        public static string tongNgayCongThuong(string manv, string thang, string nam)
        {
            ...
            bc = DAO.DAO_Timesheet.selectBangcong_1NV(manv, thang, nam);
            int t = 0;
        ...
        {
            return DAO.DAO_Timesheet.Nhanvienditre(gio, phut, thang, nam);
        }
        #endregion
        #region rpt Bang cong
        public static DataTable selectAllBC(string thang, string nam)
        {
            return DAO_Timesheet.selectAllBC(thang, nam);
        }
        #endregion
    }
}
