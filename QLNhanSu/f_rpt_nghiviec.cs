...
namespace QLNhanSu
{
    public partial class f_rpt_nghiviec : Form
    {
        public f_rpt_nghiviec()
        {
            InitializeComponent();
        }

        private void f_rpt_nghiviec_Load(object sender, EventArgs e)
        {
            addThangNam();
        }
        ...
        private void loadCrystalRpt()
        {
            ...
            DataTable dt = BUS_Report.getNhanVienNghiViec(THANG, NAM);
