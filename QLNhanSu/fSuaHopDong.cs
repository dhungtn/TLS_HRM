...
namespace QLNhanSu
{
    public partial class fSuaHopDong : DevExpress.XtraEditors.XtraForm
    {
        ...
        public fSuaHopDong(DTO.DMHopdong HD,string hoten)
        {
            this.hoten = hoten;
            this.HD = HD;
            InitializeComponent();
        ...
        private void fSuaHopDong_Load(object sender, EventArgs e)
        {
            loadDuLieu();
