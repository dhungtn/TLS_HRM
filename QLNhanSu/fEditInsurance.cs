...
namespace QLNhanSu
{
    public partial class fEditInsurance : DevExpress.XtraEditors.XtraForm
    {
        ...
        public fEditInsurance()
        {
            InitializeComponent();
        }
        public fEditInsurance(DMBaohiem BH, string manv1, string ho, string ten)
        {
            this.manv = manv1;
            this.hoten = ho+" "+ten;
        ...
        private void fSuaBaohiem_Load(object sender, EventArgs e)
        {
            lbTennv.Text = hoten;
        ...
        {
            if (BUS.BUS_Insurance.kiemtraSobaohiemTontai(sobaohiemTextEdit.Text))
            {
        ...
        private void updateBaohiem()
        {
            ...
            if (KT_SuaBaohiem())
            {
                ...
                if (BUS_Insurance.updateBaohiem(bh, soBH_truoc) == "true")
                {
        ...
        {
            if (BUS_Insurance.kiemtraSobaohiemTontai(sobaohiemTextEdit.Text))
            {
                if (soBH_truoc != sobaohiemTextEdit.Text)
                {
