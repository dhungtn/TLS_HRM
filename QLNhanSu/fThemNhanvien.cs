...
namespace QLNhanSu
{
    public partial class fThemNhanvien : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void LoadComboboxBophan()
        {
            ...
            bp = BUS.BUS_Department.compoboxBophan();
        ...
        private void image_yes_cmnd_Click(object sender, EventArgs e)
        {
            ...
            {
                fThemCmndChitiet cmnd = new fThemCmndChitiet(DateTime.Parse(ngaySinhDateEdit.Text), sochungminh, noicap, ngaycap);
                cmnd.Myget = new fThemCmndChitiet.Getstring(GetValue);
                this.Hide();
                cmnd.Show();
            }
        ...
        private void sDTTextEdit_EditValueChanged(object sender, EventArgs e)
        {
            if (sDTTextEdit.Text == "")
            {
                ...
                sDTTextEdit.ToolTip = "Nhập số điện thoại liên hệ với nhân viên";
            }
            else if (sDTTextEdit.Text.Length >= 12)
            {
        ...
        #endregion
        #region Kiểm tra mã thẻ có tồn tại hay không
        ...
        #endregion
        // clear thông tin
        #region xóa toàn bộ thông tin vừa nhập vào
