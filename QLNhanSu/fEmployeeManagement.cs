...
namespace QLNhanSu
{
    public partial class fEmployeeManagement : Form
    {
        ...
        public fEmployeeManagement(int checkbar)
        {
        ...
        {
            List<Department> bp = new List<Department>();
            bp = BUS_Department.compoboxBophan();
        ...
        private void ThemNV()
        {
            ...
            NV.reload = new fThemNhanvien.ReloadNhanvien(dataselectNV);
            NV.Show();
        }
        ...
        private void sua1Nv()
        {
            if (GridNhanvien.MainView.RowCount > 0)
            {
                ...
                fSuaNhanvien suanv = new fSuaNhanvien(nv);
                suanv.reload = new fSuaNhanvien.ReloadNhanvien(dataselectNV);
                suanv.Show();
            }
        }
        ...
        private void themHD()
        {
            if (GridNhanvien.MainView.RowCount > 0)
            {
                fThemHopdong themHD = new fThemHopdong(maNVTextEdit.Text, hoLotTextEdit.Text, tenTextEdit.Text);
                themHD.Mygetstring = new fThemHopdong.Getstring(selectHD);
                themHD.Show();
            }
            else
            {
        ...
        private void suaHD()
        {
            if (hopDongGridControl.MainView.RowCount > 0)
            {
                ...
                fSuaHopDong frm = new fSuaHopDong(hd, hoLotTextEdit.Text + " " + tenTextEdit.Text);
                frm.Mygetvalue = new fSuaHopDong.GetString(selectHD);
                frm.Show();
            }
            else
            {
        ...
        {
                dMBaoHiemGridControl.DataSource = BUS_Insurance.selectBaohiem(maNVTextEdit.Text);
        ...
        private void themBH()
        {
            if (GridNhanvien.MainView.RowCount > 0)
            {
                ...
                fThemBaohiem bh1 = new fThemBaohiem(manv1, hoLotTextEdit.Text, tenTextEdit.Text);
                bh1.MygetData = new fThemBaohiem.GetString(ReloadBH);
                bh1.Show();
            }
            else
            {
        ...
        private void xoaBH()
        {
            ...
            if (dMBaoHiemGridControl.MainView.RowCount > 0)
            {
                if (MessageBox.Show(s, "Thông báo", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    try
                    {
                        if (BUS_Insurance.deleteBaohiem(sobaohiemTextedit.Text) == "true")
                        {
                            if (dMBaoHiemGridControl.MainView.RowCount > 0)
                            {
        ...
        private void suaBH()
        {
            if (dMBaoHiemGridControl.MainView.RowCount > 0)
            {
                ...
                string manv1 = maNVTextEdit.Text;
                fEditInsurance bh1 = new fEditInsurance(BH, maNVTextEdit.Text, hoLotTextEdit.Text, tenTextEdit.Text);
                bh1.MyGetdata = new fEditInsurance.GetString(ReloadBH);
                bh1.Show();
            }
            else
            {
